			...
			case 0:
				return (
					<div className="step-0">
						...
						<p className="caption one-line">
							<span>{lang.INTRO_HINT}.</span>
							<span
								style={{ cursor: "pointer", color: "#EDA11C" }}
								onClick={() => {
									window.open(
										"https://www.maggi.com.my/en/nurturing-a-healthier-future/healthy-eats"
									);
								}}
							>
								&nbsp; {lang.FIND_OUT_MORE}
